...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1294: (x0,x1) => x0.getAttribute(x1),
      ...
      _1297: (x0,x1) => x0.closest(x1),
      _1298: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1299: x0 => x0.createRange(),
      _1300: (x0,x1) => x0.selectNode(x1),
      _1301: x0 => x0.getSelection(),
      _1302: x0 => x0.removeAllRanges(),
      _1303: (x0,x1) => x0.addRange(x1),
      _1304: (x0,x1) => x0.createElement(x1),
      _1305: (x0,x1) => x0.append(x1),
      _1306: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1307: (x0,x1) => x0.add(x1),
      _1308: x0 => x0.preventDefault(),
      ...
      _1313: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1529: (o, p) => o[p],
      _1530: (o, p, v) => o[p] = v,
      _1546: () => new AbortController(),
      _1547: x0 => x0.abort(),
      _1548: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1549: (x0,x1) => globalThis.fetch(x0,x1),
      _1550: (x0,x1) => x0.get(x1),
      _1551: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1551(f,arguments.length,x0,x1,x2) }),
      _1552: (x0,x1) => x0.forEach(x1),
      _1553: x0 => x0.getReader(),
      _1554: x0 => x0.cancel(),
      _1555: x0 => x0.read(),
      _1556: o => o instanceof Array,
      _1557: (a, i) => a.push(i),
      _1560: (a, l) => a.length = l,
      _1561: a => a.pop(),
      _1562: (a, i) => a.splice(i, 1),
      _1564: (a, s, e) => a.slice(s, e),
      _1567: a => a.length,
      _1568: (a, l) => a.length = l,
      _1569: (a, i) => a[i],
      _1570: (a, i, v) => a[i] = v,
      _1572: o => {
      ...
      _1573: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1575: o => o instanceof Uint8Array,
      _1576: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1577: o => o instanceof Int8Array,
      _1578: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1579: o => o instanceof Uint8ClampedArray,
      _1580: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1581: o => o instanceof Uint16Array,
      _1582: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1583: o => o instanceof Int16Array,
      _1584: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1585: o => o instanceof Uint32Array,
      _1586: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1587: o => o instanceof Int32Array,
      _1588: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1590: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1591: o => o instanceof Float32Array,
      _1592: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1593: o => o instanceof Float64Array,
      _1594: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1595: (t, s) => t.set(s),
      _1597: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1599: o => o.buffer,
      _1600: o => o.byteOffset,
      _1601: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1602: (b, o) => new DataView(b, o),
      _1603: (b, o, l) => new DataView(b, o, l),
      _1604: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1605: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1606: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1607: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1608: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1609: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1610: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1611: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1612: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1613: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1614: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1615: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1618: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1619: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1620: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1621: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1622: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1623: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1624: Function.prototype.call.bind(Number.prototype.toString),
      _1625: Function.prototype.call.bind(BigInt.prototype.toString),
      _1626: Function.prototype.call.bind(Number.prototype.toString),
      _1627: (d, digits) => d.toFixed(digits),
      _1653: () => globalThis.document,
      _1654: () => globalThis.window,
      _1659: (x0,x1) => { x0.height = x1 },
      _1661: (x0,x1) => { x0.width = x1 },
      _1663: (x0,x1) => { x0.pointerEvents = x1 },
      _1666: x0 => x0.head,
      _1667: x0 => x0.classList,
      _1671: (x0,x1) => { x0.innerText = x1 },
      _1672: x0 => x0.style,
      _1674: x0 => x0.sheet,
      _1675: x0 => x0.src,
      _1676: (x0,x1) => { x0.src = x1 },
      _1677: x0 => x0.naturalWidth,
      _1678: x0 => x0.naturalHeight,
      _1685: x0 => x0.offsetX,
      _1686: x0 => x0.offsetY,
      _1687: x0 => x0.button,
      _1694: x0 => x0.status,
      _1695: (x0,x1) => { x0.responseType = x1 },
      _1697: x0 => x0.response,
      _1824: x0 => x0.style,
      _3530: () => globalThis.window,
      _3592: x0 => x0.navigator,
      _3981: x0 => x0.userAgent,
      _6096: x0 => x0.target,
      _6136: x0 => x0.signal,
      _6210: () => globalThis.document,
      _6624: x0 => x0.tagName,
      _7061: x0 => x0.ctrlKey,
      ...
      _8681: x0 => x0.headers,
      _8682: x0 => x0.body,
      _11078: (x0,x1) => { x0.cursor = x1 },
      _11088: (x0,x1) => { x0.display = x1 },
      _11252: (x0,x1) => { x0.height = x1 },
      _11464: (x0,x1) => { x0.opacity = x1 },
      _11942: (x0,x1) => { x0.width = x1 },
      _12310: x0 => x0.name,
